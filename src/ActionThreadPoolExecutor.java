...
if(eventsList.size() > 0)
{
        ...
        ExecutorService executor = Executors.newFixedThreadPool(eventsList.size());//creating a pool of 1000 threads  
        for (int i = 0; i < eventsList.size(); i++) {  
            Runnable worker = new WorkerThread((int)eventsList.get(i).get("eventId"));  
